...
module.exports = class Twig {
	 ...
	 * @returns {void}
	 */
	onConfigureViewEngine(container, consolidate, next) {
		...
		container.set('conga.view.renderer', renderer);
...
//
// 	container.get('logger').debug('[conga-twig] - adding twig.js middleware');
